...
import com.codenvy.api.promises.client.callback.AsyncPromiseHelper;
import com.codenvy.api.promises.client.callback.AsyncPromiseHelper.RequestCall;
...
public class ReviewExtension implements ProjectActionHandler {
    ...
    public void onProjectOpened(final ProjectActionEvent event) {
        ...
        if (project != null
                && project.getMixins() != null
                && project.getMixins().contains(SharedConstants.PROJECTTYPE_KEY_REVIEW)) {
            Log.info(ReviewExtension.class, "Project type review found.");
